                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $subject->title }}</td>
                        <td class="break-words">{{ $subject->highlight }}</td>
                        <td>{{ $subject->video }}</td>
                        <td class="break-words">{{ $subject->pdf }}</td>
                        <td>
                            <div class="flex">
                ...
                {{-- <div class="m-4">
                    <table class="w-full rounded-lg">
                        <thead class="bg-base-300 border-2">
                            ...
                            <th class="p-3 tracking-wide">Highlight</th>
                            <th class="p-3 tracking-wide w-20">Link Video</th>
                            <th class="p-3 tracking-wide w-20">Link PDF</th>
